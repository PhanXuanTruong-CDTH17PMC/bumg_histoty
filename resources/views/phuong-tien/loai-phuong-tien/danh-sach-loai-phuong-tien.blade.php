                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 200px">
                                            <div>
                                                ...
                                                <button  type="submit" class="btn delete-confirm" id = "delete" onclick="return confirm('Bạn có chắc muốn xóa?')"data-toggle="modal" data-target="#dialog1"><a href="{{ route('loai-phuong-tien.xoa', ['id' => $loai_phuong_tien-> id]) }}"  class="btn btn-danger delete-confirm"><i class="fa fa-trash"></i></a></button>
                                            </div>			
                                        </th>
                                    </tr>                              
                            @endforeach   
